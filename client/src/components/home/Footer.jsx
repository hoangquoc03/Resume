...
const Footer = () => {
  return (
    <>
      ...
      <footer className="z-10 flex flex-wrap justify-center lg:justify-between overflow-hidden gap-10 md:gap-20 py-16 px-6 md:px-16 lg:px-24 xl:px-32 text-[13px] text-gray-500 bg-gradient-to-r from-white via-indigo-700/60 to-white ">
        <div className="flex flex-wrap items-start gap-10 md:gap-[60px] xl:gap-[140px]">
          <a href="https://prebuiltui.com">
            <img
              src="/favicon.png"
              alt=""
              className="w-[70px] -z-30 items-center"
            />
          </a>
          <div>
        ...
        <div className="text-indigo-600 flex flex-col max-md:items-center max-md:text-center gap-2 items-end">
