      ...
      <div className="min-h-screen pb-20">
        ...
        <nav className="z-50 flex items-center justify-between w-full py-4 px-6 md:px-16 lg:px-24 xl:px-40 text-sm">
          <a href="https://prebuiltui.com">
            <img src="/Favicon2.png" alt="" className="w-[80px] h-[80px]" />
          </a>
        ...
        {/* Hero Section */}
        <div className=" mt-[20px] relative flex flex-col items-center justify-center text-sm px-4 md:px-16 lg:px-24 xl:px-40 text-black">
          ...
          <p className="py-6 text-slate-600 mt-14 mb-5">
