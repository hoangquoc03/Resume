...
import ProfessionlSummaryForm from "../components/ProfessionlSummaryForm";
            ...
            <div className="relative w-full">
              ...
              <div className="absolute bottom-3 left-0 right-0 flex items-center justify-end gap-2">
                ...
                <button
                  ...
                  className="flex items-center p-2 px-6 py-2 gap-2 text-xs bg-gradient-to-br from-indigo-100 to-indigo-200 text-indigo-600 ring-indigo-300 rounded-lg hover:ring transition-colors"
                >
                  <DownloadIcon /> Dowload
                </button>
              </div>
            </div>
            {/* resume preview */}
